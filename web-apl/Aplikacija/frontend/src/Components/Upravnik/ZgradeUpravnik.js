...
const racun=400;
  ...
  function naplati(id, lokacija) {
    navigate("/Naplata", { state: { id: id, lokacija: lokacija } });
  
}
function ankete(id, lokacija) {
  
      navigate("/Ankete", { state: { id: id, lokacija: lokacija } });
              ...
              <div className="card h-100">
                ...
                <div className="card-footer p-1 pt-1 border-top-0 bg-transparent text-center">
                  <ButtonGroup className='btn-group' variant='outlined' size="sm" aria-label="neutral button group" orientation="vertical">
                    <Button className="" variant='' onClick={() => detalji(item.zgradaId, item.lokacija)}>Detalji o zgradi</Button>
                    ...
                    <Button className="" variant='' onClick={() => ankete(item.zgradaId, item.lokacija)}>Ankete</Button>
                    <Button className="" variant='' onClick={() => naplati(item.zgradaId, item.lokacija)}>Naplati</Button>
