    ...
    <div style={{ textAlign: "left" }}>
      ...
      <div className="d-flex justify-content-between align-items-center">
        ...
        onClick={() => handleFilterChange('Završen')}
          ...
          <button
          className={selectedFilter === 'Popravka je u toku' ? 'm-2 button button-pop active' : 'm-2 button button-pop'}
          onClick={() => handleFilterChange('Popravka je u toku')}
          >Popravka je u toku</button>
