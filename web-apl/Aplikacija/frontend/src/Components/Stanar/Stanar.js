        ...
        <div className="right">
          ...
          <div className="info">
            ...
            <div className="info_data">
              ...
              <div className='dugovi'>
                <h4>{user.dugovanje}</h4>

              </div>
              <Button className='btn btn-success'>
            <Link to="/PlatiRacun" className='links' style={{ textDecoration: "none", color: "white" }}>Plati</Link >
          </Button>
            </div>
          </div>
        </div>
