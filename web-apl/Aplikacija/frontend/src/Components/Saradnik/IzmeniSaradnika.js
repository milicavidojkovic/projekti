...
import slika from '../../Assets/IzmeniSaradnika.jpg';

export default function IzmeniSaradnika() {
  ...
  const IzmeniSaradnika = async (e) => {
    try {
      ...
      // };
      const response = await axiosPrivate.put(`http://localhost:8080/api/saradnik/azurirajNalogSaradnik/` + user.registrovaniKorisnikId, korisnik);
      ...
      <div className="belina">
        ...
        >
          ...
          <input
            ...
            onChange={handleChange}
          ></input>
          <p className="tekst">Ime firme</p>
          <input
            className="input"
            type="text"
            name="imeFirme"
            value={korisnik.imeFirme}
            onChange={handleChange}
          ></input>
