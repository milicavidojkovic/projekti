...
namespace FashionWeek
{
    ...
    public class ModnaKucaPregled
    {
        ...
        { }
        public ModnaKucaPregled(int kucaId, string imeOsnivaca, string sedisteKuce, string naziv)
        {
            this.KucaId = kucaId;
    ...
    public class ModnaKucaBasic
    {
        ...
        public ModnaKucaBasic(int kucaId, string imeOsnivaca, string sedisteKuce, string naziv, IList<ModniKreator> listaKreatora, IList<VlasniciMK> listaVlasnika, IList<Kolekcija> listaKolekcija)
        {
            this.KucaId = kucaId;
            this.ImeOsnivaca = imeOsnivaca;
            this.SedisteKuce = sedisteKuce;
    ...
    public class ModniKreatorPregled
    {
        ...
        public DateTime DatumRodjenja;
        public string Pol;
        public ModniKreatorPregled(int Id, string JMBG, string Ime, string Prezime,
